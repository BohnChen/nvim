...
noremap <LEADER>/ :set splitright<CR>:vsplit<CR>:res +10<CR>:term<CR>
...
" css
" Plug 'BohnChen/coc-tailwindcss', {'do': 'npm install'}
...
" ==================== coc.nvim ====================
" \ 'https://github.com/BohnChen/coc-tailwindcss',
...
inoremap <silent><expr> <TAB>
      ...
      \ CheckBackspace() ? "\<Tab>" :
      \ coc#refresh()
inoremap <expr><S-TAB> coc#pum#visible() ? coc#pum#prev(1) : "\<C-h>l Make <CR> to accept selected completion item or notify coc.nvim to format
